...
int _userProfileEntityEstimateSize(
  ...
  bytesCount += 3 + object.authStatus.length * 3;
  {
  ...
  bytesCount += 3 + object.reminderTime.length * 3;
  return bytesCount;
}
...
void _userProfileEntitySerialize(
  ...
  writer.writeString(offsets[0], object.authStatus);
...
UserProfileEntity _userProfileEntityDeserialize(
  ...
  final object = UserProfileEntity(
    authStatus: reader.readStringOrNull(offsets[0]) ?? 'guest',
    email: reader.readStringOrNull(offsets[1]),
    imagePath: reader.readStringOrNull(offsets[2]),
    name: reader.readStringOrNull(offsets[3]) ?? 'Guest',
    notificationsEnabled: reader.readBoolOrNull(offsets[4]) ?? true,
    reminderTime: reader.readStringOrNull(offsets[5]) ?? '',
  );
  object.id = id;
  return object;
}
...
P _userProfileEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'guest') as P;
    case 1:
...
extension UserProfileEntityQueryFilter
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterFilterCondition>
      authStatusContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterFilterCondition>
      authStatusMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileEntityQuerySortBy
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterSortBy>
      sortByAuthStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authStatus', Sort.asc);
    });
  }

  QueryBuilder<UserProfileEntity, UserProfileEntity, QAfterSortBy>
      sortByAuthStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authStatus', Sort.desc);
    });
  }
...
extension UserProfileEntityQueryWhereDistinct
  ...
  QueryBuilder<UserProfileEntity, UserProfileEntity, QDistinct>
      distinctByAuthStatus({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'authStatus', caseSensitive: caseSensitive);
    });
  }
...
extension UserProfileEntityQueryProperty
  ...
  QueryBuilder<UserProfileEntity, String, QQueryOperations>
      authStatusProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'authStatus');
    });
  }
